...
games.forEach(function(){
    console.log(`name: ${games[a]}`)
});
games.forEach(function(){
    console.log(`name: ${games[propertiesNames[1]]}`)
});
games.forEach(function(){
    console.log(`name: ${games[propertiesNames[2]]}`)
});
games.forEach(function(){
    console.log(`name: ${games[propertiesNames[3]]}`)
});